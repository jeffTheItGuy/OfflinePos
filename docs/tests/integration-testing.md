...
| Isolation | Truncated tables and re-seeded manager per test |

Environment variables:
| Variable | Purpose | Default |
|---|---|---|
| `DATABASE_URL` | Postgres DSN for the test database | `postgresql+psycopg2://postgres:postgres@localhost:5433/MobileToServer-POS_test` |
